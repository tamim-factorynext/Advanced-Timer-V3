...
- Update `docs/api-contract-legacy-v3.md` and `docs/schema-legacy-v3.md` in the same change set as code rename.
...
- `docs/api-contract-legacy-v3.md`, `docs/schema-legacy-v3.md`, `docs/user-guide-legacy-v3-draft.md`.
