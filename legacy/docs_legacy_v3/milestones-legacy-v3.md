...
- Outputs:
  - `src/storage/legacy_v3_config_decoder.*`
...
- Completed outputs:
  ...
  - docs parity pass:
    - `docs/decisions.md`, `docs/worklog.md`, `docs/milestones-legacy-v3.md` aligned through `M21`
...
- Implemented outputs:
  - storage DI condition contract:
    ...
    - file: `src/storage/legacy_v3_config_contract.h`
