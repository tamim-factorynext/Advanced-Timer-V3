...
| --- | --- | --- | --- | --- |
| GAP-001 | DO/SIO ignore new triggers while mission active unless idle/finished | Missing in V3 text | Carry forward | Patched in `requirements-legacy-v3-contract.md` and `AT-DO-007` |
