...
Sources reviewed: `README.md`, `src/main.cpp`, `legacy/GEMINI.md`, `legacy/docs_legacy_v3/legacy/production-firmware-kickoff-plan.md`, `legacy/docs_legacy_v3/legacy/firmware-rewrite-foundations.md`.
...
| --- | --- | --- | --- | --- |
| GAP-001 | DO/SIO ignore new triggers while mission active unless idle/finished | Missing in V3 text | Carry forward | Patched in `legacy/requirements-legacy-v3-contract.md` and `AT-DO-007` |
...
| GAP-007 | Snapshot/API envelope fields in PoC are concrete (`schemaVersion`, runtime snapshot shape, error codes) | V3 now has a frozen API payload contract and stable error model | Carry forward | Resolved in `docs/api-contract-legacy-v3.md` and acceptance matrix |
