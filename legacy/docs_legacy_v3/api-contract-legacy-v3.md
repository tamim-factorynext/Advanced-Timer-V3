...
- Config payloads embedded in API requests/responses use `schemaVersion` from `docs/schema-legacy-v3.md` (current: `2.0.0`).
...
- Runtime snapshots must include `metrics` object fields defined in `docs/timing-budget-legacy-v3.md` Section 3.
